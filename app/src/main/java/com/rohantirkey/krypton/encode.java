package com.rohantirkey.krypton;
...
public class encode {
    ...
    public static void createHuffmanTable(Node node, String encoding) {
    ...
    public static String enc(String longUrl) {
        ...
        StringBuilder url = new StringBuilder("http://RohanTY.com/");
        for(int i = 0 ; i < len ; i++) {
            char c = longUrl.charAt(i);
    ...
    public static String dec(String shortUrl) {
        int len = shortUrl.length();
        StringBuilder url = new StringBuilder();

        // {0..18} is "http://RohanTY.com/" so ignore it during decoding
        for(int i = 19 ; i < len ;) {
